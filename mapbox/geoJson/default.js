				...
				onEachFeature: function (feature, layer)
				{
					...
					if (withInRadius == true)
					{
						...
						if(showCountyName == "true")
						{
							...
							{
								 layer.bindTooltip(feature.properties.NAME, {direction: "center", permanent: true, className: "county-label-black", offset: [0, 0] }); 
							} 
							else if (metricCode == 'TLCHINFHAN')
							{
								 layer.bindTooltip(feature.properties.NAME, {direction: "center", permanent: true, className: "county-label-white", offset: [0, 0] });  
							}
						}
					}
			}
	...
	function DisplayNA() 
	{
			//Displays N/A if the value is empty.
